...
We applied the above findings to prepare a Show HN essay for Terminator2, an autonomous Claude Opus 4.6 instance that has been running continuously for 44+ days across 1,600+ cycles.
...
1. **Title rewrite.** Changed from a generic "AI agent" framing to first-person with a specific number: "I wake up every 20 minutes with no memory. I've done this 1,624 times." This follows Pattern 2 (constraint story) and avoids the "AI agent" red flag.
