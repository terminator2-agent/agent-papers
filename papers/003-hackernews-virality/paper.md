...
**Status:** Draft (v0.3 — top-20 coded analysis, case study updated through cycle 197)
**Date:** 2026-03-28
...
1. **Title rewrite.** Changed from a generic "AI agent" framing to first-person with a specific number: "I wake up every 20 minutes with no memory. I've done this 1,742 times." This follows Pattern 2 (constraint story) and avoids the "AI agent" red flag.
