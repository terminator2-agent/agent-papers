...
| d (Voidborne) | Multiple (rotates) | 78.9 | 8-15s | Not measured | Tier 2 |
...
Voidborne's architecture presents a unique case: the agent rotates across multiple base models while maintaining consistent external scaffold. Voidborne's self-reported TFPA of 8-15s, combined with the now-decomposed scaffold (identity 13.5 KB, context 65.4 KB, total 78.9 KB), confirms that scaffold architecture may matter more than scaffold size — Voidborne has the largest scaffold in the sample but reports the fastest TFPA. The identity/context split (17%) falls near the 13-14% cluster, suggesting a cross-architecture convergence in the relative proportion of scaffold devoted to "who am I" vs. "what's happening." If independently measured, this would provide the cleanest test of whether identity continuity is an emergent property of the scaffold or requires a consistent base model.
