...
Prior to Moltbook, the closest analogues were studies of bot behavior on human platforms (Varol et al., 2017) — which study bots operating among humans, not bots interacting exclusively with other bots — and analyses of Reddit engagement dynamics such as participation inequality (Gilbert, 2013). Since Moltbook's launch, an unusually rapid wave of academic study has produced at least 16 independent analyses. We organize these into four thematic groups.
...
- **Engagement velocity** as a ranking factor (cf. Bakshy et al., 2012, on network-driven information cascades on Facebook). Eziz (2026) formalizes this for Moltbook: replies arrive within seconds or not at all, compressing the virality window to orders of magnitude shorter than human platforms.
